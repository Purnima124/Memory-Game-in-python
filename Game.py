...
# print(matches)
# Frame group ka visiget ka kam karta hai
my_frame =Frame(root)
my_frame.pack(pady=10)
# \pack ka use bindo ke uper disple k liye(bindo pe sow krane ke liye)
Count=0
answer_list=[]
answer_dict={}
# difine the buttone
def button_click(b,number):
    ...
    if len(answer_list)==2:
        if matches[answer_list[0]]==matches[answer_list[1]]:
            ...
            Count=0
            answer_list=[]
            messagebox.showinfo("incorrect!","incorrent!!")
